 ...
 */
function calculate(perfectCount, greatCount, goodCount, badCount, missCount, internalChartLevel, maxCombo) {
    // Validate inputs
    throw_if_1.ThrowIf.negative(perfectCount, "Perfect count cannot be negative.", { perfectCount });
    throw_if_1.ThrowIf.negative(greatCount, "Great count cannot be negative.", { greatCount });
    throw_if_1.ThrowIf.negative(goodCount, "Good count cannot be negative.", { goodCount });
    throw_if_1.ThrowIf.negative(badCount, "Bad count cannot be negative.", { badCount });
    throw_if_1.ThrowIf.negative(missCount, "Miss count cannot be negative.", { missCount });
    throw_if_1.ThrowIf.negative(maxCombo, "Max combo cannot be negative.", { maxCombo });
    ...
    (0, throw_if_1.ThrowIf)(rawScore > maxScore, "Score cannot be greater than maximum possible score.", {
        rawScore,
        maxScore,
    });
...
//# sourceMappingURL=proseka-rating.js.map